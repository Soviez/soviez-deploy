...
[![Version](https://img.shields.io/badge/version-18.0.1.01.5-0D9488.svg)](https://hub.docker.com/r/soviez/soviez-erp)
...
| **Recommended pin** | `soviez/soviez-erp:18.0.1.01.5` / `v18.0.1.01.5` or an immutable digest — not mutable `latest` alone |

```bash
docker pull soviez/soviez-erp:18.0.1.01.5
docker pull soviez/soviez-erp:v18.0.1.01.5
```
